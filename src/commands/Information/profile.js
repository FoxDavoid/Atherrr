...
const frv = sus.roles.cache.has("1064273965410947083");
      if(frv === true) badges = badges + `\n<a:x_diamonds:1241429811256365096>・**Ather's Supporter**`;
...
else if(badges === "") badges = "\n**You don't have any badges.\nJoin our [Ather Support](https://discord.gg/HrDRR3we) to get some of the badges.**";
        }
      const pr = new EmbedBuilder()
.setAuthor({name: `Ather's Profile & Badge Panel`, iconURL: client.user.displayAvatarURL({dynamic: true})})
...
${badges ? badges : "\n**You don't have any badges.\nJoin our [Ather's Support](https://discord.gg/HrDRR3we) to get some of the badges.**"}`)
